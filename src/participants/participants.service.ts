...
export class ParticipantsService {
  ...
  async getParticipant(id: string) {
    const participant = await this.participantRepository.findByPk<Participant>(id);
    if (!participant) {
  ...
  async update(id: string, updateParticipantDto: UpdateParticipantDto) {
    ...
    participant.year_voting = updateParticipantDto.year_voting || participant.year_voting;
    participant.type_voting = updateParticipantDto.type_voting || participant.type_voting;
